//
// Counter.scala -- Counter implementation
// Project OrcScal
//
// Created by amp
//
...
class CounterRoot() extends Counter {
...
/** @author amp
  */
final class CounterNested(parent: Counter, haltContinuation: () => Unit)(implicit ctx: OrcExecutionContext) extends CounterNestedBase(parent) {
  /** Called when this whole context has halted.
    */
